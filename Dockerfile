...
ARG SERIAL_NUMBER="20240208.1000"
...
# RUN apt-get update -y && apt-get -y install redir sudo python3-pip pkg-config libfreetype6-dev libpng-dev libjpeg-dev libtiff-dev imagemagick && \
